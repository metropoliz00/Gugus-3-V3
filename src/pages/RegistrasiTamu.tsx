...
export default function RegistrasiTamu({ onLoginSuccess }: { onLoginSuccess?: (userData: any) => void }) {
  ...
  return (
    <div className="pt-28 pb-20 px-4 md:px-8 max-w-5xl mx-auto">
      {/* Top Header Card */}
      <div className="bg-gradient-to-r from-main-blue via-indigo-600 to-leaf-green p-8 md:p-12 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden mb-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl pointer-events-none" />
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 backdrop-blur-md rounded-full border border-white/20 text-xs font-bold uppercase tracking-widest text-emerald-200">
              <ShieldCheck className="w-4 h-4" /> Registrasi Akses Mandiri
            </div>
            <h1 className="text-3xl md:text-4xl font-black font-heading tracking-tight leading-tight">
              Registrasi Akun Tamu Undangan
            </h1>
            <p className="text-white/80 text-sm md:text-base max-w-xl font-light leading-relaxed">
              Daftarkan identitas Anda untuk mendapatkan akses khusus Tamu Undangan di portal KKG Gugus 03 Melati Kec. Jenu.
            </p>
          </div>
          <div className="w-20 h-20 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl flex items-center justify-center text-white shrink-0 shadow-inner">
      ...
      <AnimatePresence mode="wait">
        {successData ? (
          ...
          <motion.div
            ...
            className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-emerald-100 space-y-8"
          >
            <div className="text-center space-y-4">
              <div className="w-20 h-20 bg-emerald-50 text-emerald-500 rounded-full flex items-center justify-center mx-auto border-4 border-emerald-100 shadow-lg">
            ...
            {/* Credentials Card */}
            <div className="bg-gradient-to-br from-indigo-50/80 via-blue-50/50 to-emerald-50/50 p-6 md:p-8 rounded-3xl border border-indigo-100/80 space-y-6">
              <div className="flex items-center gap-3 text-indigo-700 font-bold text-sm border-b border-indigo-100 pb-4">
              ...
              <div className="bg-white/80 p-5 rounded-2xl border border-gray-100 space-y-2 text-xs text-gray-600">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 text-gray-500">
          ...
          >
            {/* Form Info Box */}
            <div className="bg-blue-50/70 border border-blue-100 p-5 rounded-2xl flex items-start gap-4 mb-8 text-xs text-blue-900 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: Dra. H. Siti Rahmah, M.Pd."
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all shadow-inner"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: 198205122006041002"
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-mono font-bold text-soft-black outline-none transition-all shadow-inner"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: Pembina Utama Muda / IV-c (atau - jika Non-PNS)"
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all shadow-inner"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: Pengawas Sekolah SD / Kepala Seksi Kurikulum"
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all shadow-inner"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Contoh: Dinas Pendidikan Kabupaten Tuban"
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all shadow-inner"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-4 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all shadow-inner cursor-pointer"
                  >
                  ...
                  {formData.peran === "Lainnya" && (
                    <input
                      ...
                      placeholder="Tuliskan kategori tamu Anda..."
                      className="w-full mt-3 bg-gray-50/80 border border-gray-200 focus:border-main-blue focus:bg-white p-3 rounded-2xl text-sm font-bold text-soft-black outline-none transition-all"
                    />
                  )}
                </div>
              </div>
